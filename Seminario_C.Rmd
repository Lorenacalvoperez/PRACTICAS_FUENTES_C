...
### Carga de datos JSON
```{r}
psicologos_2021<- fromJSON(file = "INPUT/DATA/psicologos_CA_2021.json")


psicologos_2022<- fromJSON(file = "INPUT/DATA/psicologos_CA_2022.json")
```

```{r}
poblacion_años<- formJSON(file="INPUT/DATA/poblacion_Ca_por_años.json")
```

```{r}
salarios_CA<- formJSON(file="INPUT/DATA/salarios_CA.json")
```
